...
def print_items_details():
    ...
    Label(main_window, font=("Helvetica", 12, "bold"), text="Row", fg="white", bg="black", relief="solid", bd=5).grid(column=0, row=7, padx=5, pady=5)
    Label(main_window, font=("Helvetica", 12, "bold"), text="Name", fg="white", bg="black", relief="sunken", bd=5).grid(column=1, row=7, padx=5, pady=5)
    Label(main_window, font=("Helvetica", 12, "bold"), text="Items Hired", fg="white", bg="black", relief="ridge", bd=5).grid(column=2, row=7, padx=5, pady=5)
    Label(main_window, font=("Helvetica", 12, "bold"), text="Receipt Number", fg="white", bg="black", relief="groove", bd=5).grid(column=3, row=7, padx=5, pady=5)
    Label(main_window, font=("Helvetica", 12, "bold"), text="Items Hired", fg="white", bg="black", relief="raised", bd=5).grid(column=4, row=7, padx=5, pady=5)
    # Add each item in the list into its own row
    while name_count < counters['total_entries']:
        Label(main_window, text=name_count, relief="sunken", font=("Helvetica", 10), fg="blue", bg="white").grid(column=0, row=name_count+8, padx=5, pady=5)
        Label(main_window, text=(Items_details[name_count][0]), relief="sunken", font=("Helvetica", 10), fg="blue", bg="white").grid(column=1, row=name_count+8, padx=5, pady=5)
        Label(main_window, text=(Items_details[name_count][1]), relief="sunken", font=("Helvetica", 10), fg="blue", bg="white").grid(column=2, row=name_count+8, padx=5, pady=5)
        Label(main_window, text=(Items_details[name_count][2]), relief="sunken", font=("Helvetica", 10), fg="blue", bg="white").grid(column=3, row=name_count+8, padx=5, pady=5)
        Label(main_window, text=(Items_details[name_count][3]), relief="sunken", font=("Helvetica", 10), fg="blue", bg="white").grid(column=4, row=name_count+8, padx=5, pady=5)
        name_count +=  1
...
def setup_buttons():
    ...
    Button(main_window, text="Print Details", command=print_items_details, width=10).grid(column=4, row=1,  padx=20, pady=12 , sticky=E)
    ...
    Button(main_window, text="Delete Row", command=delete_row, width=10).grid(column=4, row=3, padx=20, pady=12 ,sticky=E)
    Label(main_window, text="               ").grid(column=2, row=0)
...
def main():
    ...
    # Set the window icon
    icon_path = "C:/Users/23535/OneDrive - Lynfield College/2PAD/John wu 91897 and 91896 Assessment/declaration.png"  # Ensure you have an 'icon.png' file in the same directory
